...
//QUEST_2.1: Добавьте в код файла index.php простой массив категорий со следующими значениями:
    ...
    $set_product = ["Доски и лыжи", "Крепления", "Ботинки", "Одежда", "Инструменты", "Разное"];
...
//QUEST_2.2: Добавьте двумерный массив, каждый элемент которого будет ассоциативным массивом с данными одного объявления. 
    ...
    $full_product = [
        [
        'FP_name' => '2014 Rossignol District Snowboard',
        'FP_category' => 'Доски и лыжи',
        'FP_price' => '10999',
        'FP_url' => 'img/lot-1.jpg'
        ],
        [
        'FP_name' => 'DC Ply Mens 2016/2017 Snowboard',
        'FP_category' => 'Доски и лыжи',
        'FP_price' => '159999',
        'FP_url' => 'img/lot-2.jpg'
        ],
        [
        'FP_name' => 'Крепления Union Contact Pro 2015 года размер L/XL',
        'FP_category' => 'Крепления',
        'FP_price' => '8000',
        'FP_url' => 'img/lot-3.jpg'
        ],
        [
        'FP_name' => 'Ботинки для сноуборда DC Mutiny Charocal',
        'FP_category' => 'Ботинки',
        'FP_price' => '10999',
        'FP_url' => 'img/lot-4.jpg'
        ],
        [
        'FP_name' => 'Куртка для сноуборда DC Mutiny Charocal',
        'FP_category' => 'Одежда',
        'FP_price' => '7500',
        'FP_url' => 'img/lot-5.jpg'
        ],
        [
        'FP_name' => 'Маска Oakley Canopy',
        'FP_category' => 'Разное',
        'FP_price' => '5400',
        'FP_url' => 'img/lot-6.jpg'
        ],
    ];
?>
...
<!-- QUEST_2.4: Объявления выводятся как элементы списка ul.lots__list. Используя цикл для прохода по массиву с лотами, 
        	...
        	<?php foreach($full_product as $FP) { ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?= $FP['FP_url']; ?>" width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?= $FP['FP_category']; ?></span>
                    <h3 class="lot__title"><a class="text-link" href="lot.html"><?= $FP['FP_name']; ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?= $FP['FP_price']; ?><b class="rub">р</b></span>
                        </div>
...
<!-- QUEST_2.3: Найдите в HTML-коде список ul.nav__list. Используйте цикл, чтобы заменить содержимое списка данными из массива категорий./li> -->
        	<?php foreach($set_product as $SP) { ?>
            <li class="nav__item">
                <a href="all-lots.html"><?php print($SP); ?></a>
            </li>
          <?php } ?>
<!--        
						<li class="nav__item">
